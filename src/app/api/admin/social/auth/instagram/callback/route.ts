...
export async function GET(req: NextRequest) {
  ...
  const redirectUri = `${baseUrl}/api/admin/social/auth/instagram/callback`;
  ...
  return NextResponse.redirect(new URL("/admin/social?tab=settings&connected=instagram", req.url));
}
