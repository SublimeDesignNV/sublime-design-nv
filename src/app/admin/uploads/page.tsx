  ...
  return (
    <main className="bg-cream px-4 pb-16 pt-8 md:px-8">
      <div className="mx-auto max-w-7xl">
        <h1 className="mt-8 text-4xl text-charcoal">Upload Media</h1>
        <p className="mt-3 max-w-3xl font-ui text-sm text-gray-mid">
          Upload photos and videos, review recent batches, and turn a fresh batch into a project without digging through the full content library.
        </p>
