...
const swColors = require("./sw-colors.json") as {
  code: string; name: string; hex: string; r: number; g: number; b: number;
}[];
// eslint-disable-next-line @typescript-eslint/no-require-imports
const varathaneColors = require("./varathane-colors.json") as typeof swColors;
// eslint-disable-next-line @typescript-eslint/no-require-imports
const gfColors = require("./gf-colors.json") as typeof swColors;
// eslint-disable-next-line @typescript-eslint/no-require-imports
const rubioColors = require("./rubio-colors.json") as typeof swColors;
// eslint-disable-next-line @typescript-eslint/no-require-imports
const minwaxColors = require("./minwax-colors.json") as typeof swColors;
